...
export class EditSpecialtyComponent {
  ...
  onUpdate() {
    this.specialtiesService.putSpecialty(this.specialty.id, this.specialty).subscribe(res => {
      this.snackBar.open('Специальность успешно изменена', null, {duration: 2000});
    });
  }
}
