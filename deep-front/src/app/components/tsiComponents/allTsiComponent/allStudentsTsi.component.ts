...
@Component({
  selector: 'all-tsi',
  templateUrl: './allStudentsTsi.component.html',
})
export class AllStudentsTsiComponent{
  ...
  ngOnInit() {
    ...
    this.tsisService.getStudentTSIs(this.id).subscribe(res => this.dataSource.data = res as TSI[]);
  }
